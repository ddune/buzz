...
export const KIND_JOB_REJECTED = 43003;
export const KIND_JOB_COMPLETED = 43004;
export const KIND_JOB_BLOCKED = 43005;
export const KIND_JOB_DELEGATED = 43006;
...
export const CHANNEL_TIMELINE_CONTENT_KINDS = [
  ...
  KIND_JOB_REJECTED, // 43003
  KIND_JOB_COMPLETED, // 43004
  KIND_JOB_BLOCKED, // 43005
  KIND_JOB_DELEGATED, // 43006
