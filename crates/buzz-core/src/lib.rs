...
pub mod channel;
/// Delegated-job event schema and lifecycle state machine.
pub mod delegated_job;
...
pub mod relay;
/// Durable admission of supplemental context for accepted delegated jobs.
pub mod supplemental_context;
